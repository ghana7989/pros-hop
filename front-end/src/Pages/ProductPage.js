...
import { PRODUCT_CREATE_REVIEW_RESET } from '../actionTypes/productsActionTypes';
...
const ProductPage = ({ match, history }) => {
  ...
  useEffect(() => {
    if (productReviewError === "Product already reviewed") {
      setRating(0)
      setComment('')
    }
  ...
  }, [dispatch, match.params.id, productReviewError, productReviewSuccess]);
